...
public class EuclideanDistanceTests extends TestCase {
	...
	public void testArrayLengthMatcherWitDifferentAPsInRTsample() {
		...
		ScanSampleGSM sSpl1 = new ScanSampleGSM("res1", "00:00:00:00:01", new RSS(10), 2411);
		ScanSampleGSM sSpl2 = new ScanSampleGSM("res2", "00:00:00:00:02", new RSS(20), 2412);
		ScanSampleGSM sSpl3 = new ScanSampleGSM("res3", "00:00:00:00:03", new RSS(30), 2413);
		...
		ScanSampleGSM sSpl4 = new ScanSampleGSM("res1", "00:00:00:00:01", new RSS(40), 2414);
		ScanSampleGSM sSpl5 = new ScanSampleGSM("res2", "00:00:00:00:02", new RSS(50), 2415);
	...
	public void testArrayLengthMatcherWithNoAPsInRT() {
		...
		LFPT rmLFPT = new LFPT(123456789,5,new IGeoPoint(1,2));
		ScanSampleList LFPTSSplList = new ScanSampleList();
		ScanSampleGSM sSpl4 = new ScanSampleGSM("res4", "00:00:00:00:04", new RSS(40), 2414);
		ScanSampleGSM sSpl5 = new ScanSampleGSM("res2", "00:00:00:00:02", new RSS(50), 2415);
		ScanSampleGSM sSpl6 = new ScanSampleGSM("res6", "00:00:00:00:06", new RSS(60), 2416);
		LFPTSSplList.add(sSpl4);
		LFPTSSplList.add(sSpl5);
	...
	public void testArrayLengthMatcherWith2DifferentScanners() {
		...
		sSpl1 = new ScanSampleGSM("resX1", "00:00:00:00:11", new RSS(100), 2411);
		sSpl2 = new ScanSampleGSM("resX2", "00:00:00:00:12", new RSS(200), 2412);
		sSpl3 = new ScanSampleGSM("resX3", "00:00:00:00:13", new RSS(300), 2413);
		rtSSplList.add(sSpl1);
		rtSSplList.add(sSpl2);
		rtSSplList.add(sSpl3);
		...
		sSpl4 = new ScanSampleGSM("resX4", "00:00:00:00:14", new RSS(400), 2414);
		sSpl5 = new ScanSampleGSM("resX2", "00:00:00:00:12", new RSS(500), 2415);
		sSpl6 = new ScanSampleGSM("resX6", "00:00:00:00:16", new RSS(600), 2416);
		LFPTSSplList.add(sSpl4);
		LFPTSSplList.add(sSpl5);
		LFPTSSplList.add(sSpl6);

...
public class PersistanceManagerTest extends AndroidTestCase{
	...
	public void setUp() throws Exception {
		...
		sSplDBPersProvider.putItem(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID, ScanSample80211DBPersistance.class);
	...
	public void testSaveWithScanSample() throws InterruptedException {
		for(int i=0; i<=bufferSize; i++){
			...
			sSList.add(scnSpl1);
			lfptToSave.add(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID, sSList);
			persMngr.save(PersistanceManager.GATEWAY_LFPT, lfptToSave);
		}
		Thread.sleep(1000);
		...
		ScanSampleList sSList = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);
	...
	public void testSaveWith2LFPTsAnd2ScanSamples() throws InterruptedException {
		...
		for(int i=0; i<=bufferSize; i++){
			...
			sSList1.add(scnSpl1);
			sSList1.add(scnSpl2);
			lfptToSave1.add(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID, sSList1);
		...
		for(int i=0; i<=bufferSize; i++){
			...
			sSList2.add(scnSpl3);
			sSList2.add(scnSpl4);
			lfptToSave2.add(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID, sSList2);
		...
		ScanSampleList sSList1 = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);
		...
		ScanSampleList sSList2 = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);

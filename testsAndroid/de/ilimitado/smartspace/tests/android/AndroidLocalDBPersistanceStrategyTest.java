...
public class AndroidLocalDBPersistanceStrategyTest extends AndroidTestCase{
	...
	public void testSaveWithScanSample() {
		...
		sSList = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);
	...
	public void testSaveWith2LFPTsAnd2ScanSamples() {
		...
		sSList1 = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);
		...
		sSList2 = (ScanSampleList) lfpt.get(Configuration.getInstance().sensorConfig80211.scanner80211PassiveConf.ID);
